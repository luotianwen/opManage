...
public class SDKClientProxy implements com.op.plugin.emayclient.sdkhttp.SDKClient {
  private String _endpoint = null;
  private com.op.plugin.emayclient.sdkhttp.SDKClient sDKClient = null;
  ...
  private void _initSDKClientProxy() {
    try {
      sDKClient = (new com.op.plugin.emayclient.sdkhttp.SDKServiceLocator()).getSDKService();
      if (sDKClient != null) {
        if (_endpoint != null)
  ...
  public com.op.plugin.emayclient.sdkhttp.SDKClient getSDKClient() {
    if (sDKClient == null)
      _initSDKClientProxy();
    return sDKClient;
  }
