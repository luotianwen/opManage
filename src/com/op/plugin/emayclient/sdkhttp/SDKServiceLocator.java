...
public class SDKServiceLocator extends org.apache.axis.client.Service implements com.op.plugin.emayclient.sdkhttp.SDKService {
...
//    private java.lang.String SDKService_address = "http://116.58.219.223:8081/sdk/SDKService";
    	 ...
    	 private java.lang.String SDKService_address =PropertyResourceBundle.getBundle("emayclient").getString("uri");
    ...
    public com.op.plugin.emayclient.sdkhttp.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.op.plugin.emayclient.sdkhttp.SDKServiceBindingStub _stub = new com.op.plugin.emayclient.sdkhttp.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.op.plugin.emayclient.sdkhttp.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                com.op.plugin.emayclient.sdkhttp.SDKServiceBindingStub _stub = new com.op.plugin.emayclient.sdkhttp.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
