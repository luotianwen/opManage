...
public class ScreeningDTO implements Serializable{
	 ...
	 * @return
	 */
	public List<Screening> getSubScreening() {
		return subScreening;
	}
	 ...
	 * @return
	 */
	public void setSubScreening(List<Screening> subScreening) {
		this.subScreening = subScreening;
	}
