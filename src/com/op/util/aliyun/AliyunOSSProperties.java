...
public class AliyunOSSProperties {
    ...
    static {
        ...
        VISITURL = map.get("VisitURL");
        if (VISITURL == null) {
            throw new RuntimeException("VisitURL property is not configured in aliyunoss.properties!!!");
        }
        LOCALURL = map.get("LocalURL");
        if (LOCALURL == null) {
            throw new RuntimeException("LocalURL property is not configured in aliyunoss.properties!!!");
        }
