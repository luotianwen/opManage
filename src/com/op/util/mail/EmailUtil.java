...
public class EmailUtil{
	...
	private EmailTemplateService emailTemplateServiceImpl;
	    ...
	    * @return
	    */
	   public String testSendCheckEmail(String toAddress,String key){
		   	String yzm = Tools.getRandomNum()+"";
		   	EmailTemplate template = getEmailTemplate(key);
		   	// 取得velocity的上下文context
		   	Map<String,Object> parameter = new HashMap<String,Object>();
		   	parameter.put("yanzhengma", yzm);
		   	String content = this.processTemplate(template.getEt_template(), parameter);
		    sendEmail(toAddress,template.getEt_title()+"【系统测试邮件】",content);
			return yzm;
	   }
	    ...
	    * @param parameter 模板参数 上下文 map结构
	    */
	   public void testSendEmail(String toAddress,String key,Map<String,Object> parameter){
		   	EmailTemplate template = getEmailTemplate(key);
		   	String content = this.processTemplate(template.getEt_template(), parameter);
		    sendEmail(toAddress,template.getEt_title()+"【系统测试邮件】",content);
	   }		    
		...
		public EmailTemplate getEmailTemplate(String key){
	    	...
	    	// 获取
			byte[] bs = jedis.get("EmailTemplate".getBytes());
	...
	public static void main(String[] args){   
     ...
     mailInfo.setUserName("791507073@qq.com");    
     mailInfo.setPassword("oacqbfmatsfibeeh");//您的邮箱密码    
     mailInfo.setFromAddress("791507073@qq.com");    
     mailInfo.setToAddress("2355566253@qq.com");    
