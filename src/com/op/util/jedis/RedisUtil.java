	...
	static {
		try {
			...
			dev =Boolean.parseBoolean(map.get("dev"));
		     if (ADDR == null) {
		         throw new RuntimeException("ADDR property is not configured in redisconfig.properties!!!");
		     }
		     PORT = Integer.valueOf(map.get("PORT"));
		     if (PORT == 0) {
		         throw new RuntimeException("PORT property is not configured in redisconfig.properties!!!");
		     }
		     AUTH = map.get("AUTH");
		     if (AUTH == null) {
		         throw new RuntimeException("AUTH property is not configured in redisconfig.properties!!!");
		     }
		     MAX_ACTIVE = Integer.valueOf(map.get("MAX_ACTIVE"));
		     if (MAX_ACTIVE == 0) {
		         throw new RuntimeException("MAX_ACTIVE property is not configured in redisconfig.properties!!!");
		     }
		     MAX_IDLE = Integer.valueOf(map.get("MAX_IDLE"));
		     if (MAX_IDLE == 0) {
		         throw new RuntimeException("MAX_IDLE property is not configured in redisconfig.properties!!!");
		     }
		     MAX_WAIT = Integer.valueOf(map.get("MAX_WAIT"));
		     if (MAX_WAIT == 0) {
		         throw new RuntimeException("MAX_WAIT property is not configured in redisconfig.properties!!!");
		     }
		     TIMEOUT = Integer.valueOf(map.get("TIMEOUT"));
		     if (TIMEOUT == 0) {
		         throw new RuntimeException("TIMEOUT property is not configured in redisconfig.properties!!!");
		     }
