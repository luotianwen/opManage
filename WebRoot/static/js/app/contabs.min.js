$(function() {
    ...
    function n() {
        ...
        if (parent.parent.$(".J_menuTab").each(function() {
            return $(this).data("id") == t ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), e(this), parent.parent.$(".J_mainContent .J_iframe").each(function() {
            ...
            parent.parent.$(".J_menuTab").removeClass("active");
            var r = '<iframe class="J_iframe" name="iframe' + a + '" width="100%" height="100%" src="' + t + '" frameborder="0" data-id="' + t + '" seamless></iframe>';
            parent.parent.$(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(r);
            var o = layer.load();
            parent.parent.$(".J_mainContent iframe:visible").load(function() {
                layer.close(o);
            }),
            parent.parent.$(".J_menuTabs .page-tabs-content").append(s),
            e(parent.parent.$(".J_menuTab.active"))
        }
        return ! 1
    }
    function s() {
