$(function() {
    ...
    function n() {
        ...
        if (parent.$(".J_menuTab").each(function() {
            return $(this).data("id") == t ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), e(this), parent.$(".J_mainContent .J_iframe").each(function() {
            ...
            parent.$(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(r);
            var o = layer.load();
            parent.$(".J_mainContent iframe:visible").load(function() {
                layer.close(o)
            }),
            parent.$(".J_menuTabs .page-tabs-content").append(s),
            e(parent.$(".J_menuTab.active"))
        }
        return ! 1
    }
    function s() {
