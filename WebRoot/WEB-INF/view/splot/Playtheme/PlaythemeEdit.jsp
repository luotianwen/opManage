            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="editTypeForm" >
                        <input type="hidden" name="id" value="${playtheme.id }" />
                        <div class="form-group">
                            <label class="col-sm-2 control-label">游玩主题名称</label>

                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="游玩主题名称" id="name" name="name" value="${playtheme.name}" >
                            </div>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="status" >
                                    <option value="1" <c:if test="${playtheme.status==1 }">selected</c:if>>正常</option>
                                    <option value="0" <c:if test="${playtheme.status==0 }">selected</c:if>>下线</option>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="说明" id="notes" name="notes" value="${playtheme.notes}" >
                            </div>
                                ...
                                <script type="text/javascript">
                                    function save_playtheme(){
                                        if(check_in()){
                                            ...
                                            $.post('playtheme/updatePlaytheme.json',$('#editTypeForm').serialize(),function(data){
