            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="editTypeForm" >
                        <input type="hidden" name="id" value="${scenicspotintroduction.id }" />
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea id="content"  name="content"  style="width:100%;height:200px;">${scenicspotintroduction.content }</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button class="btn btn-primary" type="button" onclick="save_scenicspotintroduction()" ><i class="fa fa-save"></i>&nbsp;保存</button>
                                <script type="text/javascript">
                                    var ue = UE.getEditor("content");
                                    function save_scenicspotintroduction(){
                                        if(check_in()){
                                            layer.load(0,{shade:0.3});
                                            var url="scenicspotintroduction/saveScenicspotintroduction.json";
                                            var id=$("#id").val();
                                            if(id!=''&&id>0){
                                                url="scenicspotintroduction/updateScenicspotintroduction.json";
                                            }
