...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="attractionsfacilities/attractionsfacilitiesList.html" method="post" >
	...
	$(function () {
		...
		$("button[id='edit']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "attractionsfacilities/editAttractionsfacilities.html?id="+id
			});
		});
		...
		$("button[id='add']").on("click" , function(){
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "attractionsfacilities/editAttractionsfacilities.html"
			});
		});
