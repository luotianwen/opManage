...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="ticketinformation/ticketinformationList.html" method="post" >
					<div class="ibox-content">
						<h2>门票信息</h2>
						<div class="input-group">
							<div class="col-md-6">
								<input type="text" placeholder="景点名称" name="t" value="${page.t }" class="input form-control">
							</div>
							<div class="col-md-3">
										...
										<table class="table table-striped table-hover">
											...
											<c:forEach items="${spot}" var="list" >
												<tr>
															...
															<td>${list.sid}</td>
															<td>${list.name}</td>
															<td>${list.peakseasonfare}</td>
															<td>${list.offseasorates}</td>
													<td class="center">
	...
	$(function () {
		...
		$("button[id='edit']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["80%", "90%"],
				content: "ticketinformation/editTicketinformation.html?id="+id
			});
		});
		...
		$("button[id='add']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["80%", "90%"],
				content: "ticketinformation/editTicketinformation.html?sid="+sid
			});
		});
