...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="productclassification/productclassificationList.html" method="post" >
								...
								<div class="full-height-scroll">
									<div class="table-responsive">
										<table class="table table-striped table-hover">
											...
											<tbody>
											<c:forEach items="${productclassification}" var="list" >
												<tr>
													<td>
	...
	$(function () {
		...
		$("button[id='edit']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "productclassification/editProductclassification.html?id="+id
			});
		});
		...
		$("button[id='add']").on("click" , function(){
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "productclassification/editProductclassification.html"
			});
		});
