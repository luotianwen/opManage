...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="characteristicaspect/characteristicaspectList.html" method="post" >
								...
								<div class="full-height-scroll">
									<div class="table-responsive">
										<table class="table table-striped table-hover">
											...
											<tbody>
											<c:forEach items="${characteristicaspect}" var="list" >
												<tr>
	...
	$(function () {
		...
		$("button[id='delete']").on("click" , function(){
			...
			layer.confirm(message,{shade:0.3,btn:['确认','取消'],icon:3},function(index){
				...
				$.post('characteristicaspect/deleteCharacteristicaspect',{mId:mId,tp:0},function(data){
		...
		$("button[id='edit']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["50%", "80%"],
				content: "characteristicaspect/editCharacteristicaspect.html?id="+id
			});
		});
		...
		$("button[id='sadd']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["50%", "80%"],
				content: "characteristicaspect/editCharacteristicaspect.html?sid="+sid
			});
		});
		...
		$("button[id='add']").on("click" , function(){
			layer.open({
				...
				shade: 0.2,
				area: ["50%", "80%"],
				content: "characteristicaspect/editCharacteristicaspect.html"
			});
		});
