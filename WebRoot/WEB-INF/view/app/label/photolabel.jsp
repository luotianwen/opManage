...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="label/photoLabel.html" method="post" >
										...
										<table class="table table-striped table-hover">
											...
											<c:forEach items="${list}" var="list" >
												<tr>
													...
													<td>${list.pl_content}</td>
													<td class="center">
														<p data-id="${list.pl_content}">
															<button type="button" id="edit" class="btn btn-outline btn-primary"><i class="fa fa-paste"></i> 设为系统标签</button>
														</p>
													</td>
												</tr>
											</c:forEach>
...
<script>
	...
	$(function () {
		...
		$("button[id='edit']").on("click" , function(){
			...
			$.post("label/updatePhotoLabel.html?name="+name,function(data){
