...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="label/findAllLabel.html" method="post" >
					<div class="ibox-content">
						...
						<div class="input-group">
							...
							<div class="col-md-3">
								<a class="J_menuItem" data-index="0" href="label/photoLabel.html"><i class="fa fa-paste"></i> 查看用户自定义标签</a>
							</div>
						</div>
										...
										<table class="table table-striped table-hover">
											...
											<c:forEach items="${list}" var="list" >
												<tr>
													...
													<td>${list.l_name}</td>
													<td>
														<c:if test="${list.l_status==0 }">
															正常
														</c:if>
														<c:if test="${list.l_status==1 }">
															暂停使用
														</c:if>
													</td>
													<td class="center">
	...
	$(function () {
		...
		$("button[id='edit']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "label/findLabelById.html?id="+id
			});
		});
		...
		$("button[id='add']").on("click" , function(){
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "label/findLabelById.html"
			});
		});
