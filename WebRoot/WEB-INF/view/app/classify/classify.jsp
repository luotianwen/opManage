...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="classify/findAllClassify.html" method="post" >
										...
										<table class="table table-striped table-hover">
											...
											<c:forEach items="${list}" var="list" >
												<tr>
													...
													<td>${list.c_name}</td>
													<td>
														<c:if test="${list.c_status==0 }">
															正常
														</c:if>
														<c:if test="${list.c_status==1 }">
															暂停使用
														</c:if>
													</td>
													<td class="center">
	...
	$(function () {
		...
		$("button[id='edit']").on("click" , function(){
			...
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "classify/findClassifyById.html?id="+id
			});
		});
		...
		$("button[id='add']").on("click" , function(){
			layer.open({
				...
				shade: 0.2,
				area: ["40%", "50%"],
				content: "classify/findClassifyById.html"
			});
		});
