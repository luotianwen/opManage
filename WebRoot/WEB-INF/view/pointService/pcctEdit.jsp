                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" id="editTypeForm" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="描述" id="pcct_describe" name="pcct_describe" value="${p.pcct_describe }" >
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    function save_menu(){
                                    	if(check_in()){
                                    		...
                                    		$.post('pcct/save.json',$('#editTypeForm').serialize(),function(data){
                                    ...
                                    function check_in(){
                                    	...
                                    	if($('#pcct_describe').val().trim() == ''){
                                    		layer.tips('字典描述不能为空!!!', '#pcct_describe', {
											    tips: [1, '#019F95'],
											    time: 1500
											});
											$('#pcct_describe').focus();
