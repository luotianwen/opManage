...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
				...
				<div class="ibox">
					<div class="ibox-content">
                        <form action="" id="vettedForm" method="post" class="form-horizontal">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">法人代表手机</label>
                                <div class="col-sm-10">
                                	${vetted.mobile }
                                </div>
                            </div> 
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">企业固定电话</label>
                                <div class="col-sm-10">
                                	${vetted.telephone }
                                </div>
                            </div> 
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">企业城市</label>
                                <div class="col-sm-10">
                                ${vetted.cityId }
                                </div>
                            </div> 
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">法人代表QQ</label>
                                <div class="col-sm-10">
                                ${vetted.qq }
                                </div>
                            </div> 
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">法人代表证件照-正面</label>
                                <div class="col-sm-10">
                               		 <div class="photos">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">法人代表证件照-反面</label>
                                <div class="col-sm-10">
                               		 <div class="photos">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">法人代表手持证件照</label>
                                <div class="col-sm-10">
                               		 <div class="photos">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">企业注册名称</label>
                                <div class="col-sm-10">
                                ${vetted.enterpriseName }
                                </div>
                            </div>  
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">企业首页</label>
                                <div class="col-sm-10">
                                ${vetted.enterpriseHomepage }
                                </div>
                            </div>  
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                               		 <div class="photos">
                                            <img  alt="image" class="feed-photo" src="${vetted.licensePictureUrl }">
                                     </div>
                                     <span class="help-block m-b-none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                ${vetted.enterpriseIntro }
                                </div>
                            </div>  
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">俱乐部名称</label>
                                <div class="col-sm-10">
                                ${vetted.clubName }
                                </div>
                            </div>   
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">俱乐部logo</label>
                                <div class="col-sm-10">
                                 	<div class="photos">
                                            <img  alt="image" class="feed-photo" src="${vetted.clubLogo }">
                                     </div>
                                </div>
                            </div>   
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">俱乐部介绍</label>
                                <div class="col-sm-10">
                                ${vetted.clubIntro }
                                </div>
                            </div> 
	    ...
	    <div id="shenfenzheng2" style="display: none;" ><img src="static/images/sample/shenfenzheng2.jpg"></div>
 		<div id="zhizhao" style="display: none;" ><img src="img/sample/zhizhao.jpg"></div>
