                       ...
                       <div class="hr-line-dashed"></div> 
                            <div class="tab-content">
                                <div class="tab-pane active">
                                                ...
                                                <tbody>
                                                	...
                                                	<tr>
                                                        ...
                                                        <td> 
	                                                        ...
	                                                        <span class="badge badge-warning badge-rounded">发布待审核</span>
	                                                        </c:if>
	                                                        <c:if test="${activity.state == 4 }">
	                                                        <span class="badge badge-danger badge-rounded">审核不通过</span>
	                                                        </c:if>
                                                         </td> 
                                    ...
                                    <div class="ibox-content">
	                                     <p>
					                        <button type="button" id="activitys-edit" class="btn btn-sm btn-primary">批量审核</button>
										 </p>
                                    </div>
