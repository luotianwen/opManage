                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header" >
                        <div class="dropdown profile-element">
                            <span><img alt="image" id="userAvatar" class="img-circle" style="width: 80px;height: 80px;" src="${SESSION_USER.uHeadImg }" /></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="user/sysUserAvatar.html">修改头像</a>
                                </li>
                                <li><a class="J_menuItem" href="user/sysUserPassword.html">修改密码</a>
                                </li>
                                <li class="divider"></li>
                                <li><a href="user/logout.html">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        <div class="logo-element">玩嘛
                        </div>
                    </li>
