    ...
    <div class="wrapper wrapper-content  animated fadeInRight">
        <div class="row">
            <div id="user-box" class="col-sm-12">
                <div class="ibox">
                <form id="travels" action="travels/manageTravels.html" method="post" >
                                            ...
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                	...
                                                	<tr>
                                                        ...
                                                        <td>
                                                        	<a data-toggle="tab" href="#contact-1" class="client-link">${item.auditor_id }</a>
                                                        </td> 
                                                        <td> <fmt:formatDate value="${item.auditor_time }" type="both"/> </td> 
                                                        <td>
                                                        	<c:if test="${item.issued_state=='2' }">
                                                        		<a data-toggle="tab" href="#contact-1" class="client-link">等待审核</a>
                                                        	</c:if>
                                                        	<c:if test="${item.issued_state=='3' }">
                                                        		<a data-toggle="tab" href="#contact-1" class="client-link">审核成功</a>
                                                        	</c:if>
                                                        	<c:if test="${item.issued_state=='4' }">
                                                        ...
                                                        <td>
                                                        	<a data-toggle="tab" href="#contact-1" class="client-link">${item.auditNotes }</a>
                                                        </td> 
                                                        
                                                        <td class="center">
	                                                        <p data-id="${item.id }">
	                                                        	<button type="button" id="travel-edit" class="btn btn-outline btn-primary"><i class="fa fa-paste"></i> 审核</button>
										                        <a href="javascript:void(window.open('${url }/travels/detail/${item.id}.html?type=admin'))"><button type="button" class="btn btn-outline btn-primary"><i class="fa fa-paste"></i> 查看</button></a>
										                    </p>
                                                        </td>
                                                    </tr>
                                                	</c:forEach>
