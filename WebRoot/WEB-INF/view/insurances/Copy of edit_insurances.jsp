                        ...
                        <form method="get" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                       ...
                                       <span class="help-block m-b-none">保障期限和价格，请<a href="http://cps.hzins.com/cz306926/product/detail-${i.productId }.html" style="color: red;" target="_blank"><b>点击此处</b></a>查看费率表设置！</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
	                                        <div class="col-md-2">
	                                            <input type="text" placeholder="承保年龄开始" class="form-control" name="startAge" value="${d.startAge }">
	                                        </div>
	                                        <div class="col-md-1">
	                                            <label class="control-label">——</label>
	                                        </div>
	                                        <div class="col-md-2">
	                                            <input type="text" placeholder="承保年龄结束" class="form-control" name="endAge" value="${d.endAge }">
	                                        </div>
	                                        <div class="col-md-1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                     <c:if test="${i.isEnable == 0 }"><label class="control-label">未下架</label></c:if> 
                                     <c:if test="${i.isEnable == 1 }"><label class="control-label">下架</label></c:if> 
                                </div>
                            </div><%-- 
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 350px;">
                                    	<div class="col-md-3">
										<input type="text" placeholder="开始" class="form-control" name="minDeadline" value="${d.minDeadline }">
										</div>   
                                    	<div class="col-md-1" style="width: 1px;">
											<label class="control-label">-</label>
										</div>   
										<div class="col-md-3">
										<input type="text" placeholder="结束" class="form-control" name="maxDeadline" value="${d.maxDeadline }">
										</div>
										<div class="col-md-4">
                                    ...
                                    <td>
                                    	<input type="text" placeholder="价格" class="form-control" name="price" value="${d.price }">
                                    </td>
                                    <td>
                                    	<input type="text" placeholder="价格" class="form-control" name="price" value="${d.price }">
                                    </td>
