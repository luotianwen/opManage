                    ...
                    <div class="ibox-content">
						...
						function add_array(){
				       		layer.open({
								...
								closeBtn: 1,
								skin : 'layui-layer-molv',
								content : 'view/admin/authority/arrayAdd.jsp' 
							});
						}
						function delete_array(){
							...
							layer.confirm('确认删除名为【'+aName+'】分组吗?删除该分组之后，处于该分组之下的角色都将进行删除!',{btn:['确认删除','取消'],icon:3},function(index){
								...
								$.post('arrays/deleteArray.do',{aId:'${aId }'},function(data){
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            function edit_role(rId,rName,rOrder){
									       		layer.open({
													...
													closeBtn: 1,
													skin : 'layui-layer-molv',
													content : 'view/admin/authority/roleEdit.jsp?rId='+rId+'&rName='+rName+'&rOrder='+rOrder
												});
                                            }
                                            function delete_role(rId){
                                            	layer.confirm('确认删除该角色吗?',{btn:['确认删除','取消'],icon:3},function(index){
                                            		layer.load(0,{shade:0.3});
                                            		$.post('roles/deleteRoleByRId.do',{rId:rId},function(data){
	                       ...
	                       <script type="text/javascript">
							function add_role(){
					       		layer.open({
									...
									closeBtn: 1,
									skin : 'layui-layer-molv',
									content : 'view/admin/authority/roleAdd.jsp?aId='+'${aId }'
								});
							}
	                       </script>
	                    </div>
