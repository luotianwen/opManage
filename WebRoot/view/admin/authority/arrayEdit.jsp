                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" id="add_array_form" >
                        	<input type="hidden" name="aId" value="${array.aId }" />
                            <div class="form-group">
                                <label class="col-sm-2 control-label">分组名称</label>
                                
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="分组名称" id="aName" name="aName" maxlength="50" value="${array.aName }" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="排序" id="aOrder" name="aOrder" value="${array.aOrder }" >
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    function save_array(){
                                    	if(check_in()){
                                    		...
                                    		$.post('arrays/updateArray.do',$('#add_array_form').serialize(),function(data){
