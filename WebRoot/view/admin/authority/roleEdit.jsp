            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" id="edit_role_form" >
                        	<input type="hidden" name="rId" value="<%=request.getParameter("rId") %>" />
                            <div class="form-group">
                                <label class="col-sm-2 control-label">角色名称</label>
                                
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="角色名称" id="rName" name="rName" maxlength="50" value="<%=request.getParameter("rName") %>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="排序" id="rOrder" name="rOrder" value="<%=request.getParameter("rOrder") %>" >
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    function save_array(){
                                    	if(check_in()){
                                    		...
                                    		$.post('roles/updateRole.do',$('#edit_role_form').serialize(),function(data){
