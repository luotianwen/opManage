...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl:  "/ueditor/dispatch.html"

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        , toolbars: [[
				"fullscreen", "source", "undo", "redo", "bold", "italic", "underline", "fontborder", 
				"backcolor", "fontsize", "fontfamily", "justifyleft", "justifyright", "justifycenter",
				"justifyjustify", "strikethrough", "superscript", "subscript", "removeformat", 
